...
###### Congratulations, you have successfully set up intra-region VPC peering between different AWS accounts and tested connectivity between instances in each VPC
